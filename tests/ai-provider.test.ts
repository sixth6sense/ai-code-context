import { OpenAIProvider, AnthropicProvider, LocalProvider, createAIProvider } from '../src/ai-provider';
...
describe('AI Providers', () => {
  ...
  describe('OpenAIProvider', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await expect(provider.analyzeCode('Test prompt', 'Test code'))
  ...
  describe('createAIProvider', () => {
    it('should create OpenAI provider', () => {
      const provider = createAIProvider({ ...mockConfig, aiProvider: 'openai' });
      expect(provider).toBeInstanceOf(OpenAIProvider);
    });

    it('should create Anthropic provider', () => {
      const provider = createAIProvider({ ...mockConfig, aiProvider: 'anthropic' });
